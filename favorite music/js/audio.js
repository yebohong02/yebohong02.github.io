...
// 后台音乐列表
let musicData = [['叹云兮', '鞠婧祎'], ['探窗', '国风新语'], ['故里雪', '陈晓竹'], ['赐我', '一只白羊'],['镜中渊', '周林枫'],
				['彼岸花开无人归', '迈兮'],['渡我', '三楠'],['归寻', '邓寓君(等什么君)'],['画中笼', '周林枫'],['嫁与娶', '周林枫'],
				['浪子闲话', '花僮'],['离人赋', '云汐'],['落花偶遇', '有声有社'],['青衣', '草帽酱'],['娶', '三楠'],
				['人间惊鸿客', '叶里'],['人间惊鸿宴', '指尖笑'],['山鬼', '锦零'],['笑纳', '花僮'],['怎叹', '邓寓君(等什么君)'],['罪与爱', '周林枫']];
...
audio.onended = function () {
    if (modeId == 2) {
        ...
        var oldId = musicId;
        while (true) {
            musicId = Math.floor(Math.random() * 20) + 0;
